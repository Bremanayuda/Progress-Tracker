    ...
    <main class="main-content" style="margin-top:32px; text-align:center;">
        <div style="margin-bottom:24px;">
            ...
            <ul style="list-style: none; padding:0;">
                ...
                <li>• Lihat status peminjaman di dashboard</li>
                <li>• Lihat riwayat peminjaman</li>
            </ul>
        </div>
        <a href="{{ route('general.peminjaman.create') }}" class="save-profile-btn" style="max-width:260px; margin-bottom: 10px;">Ajukan Peminjaman Barang</a>
        <br>
        <a href="{{ route('general.peminjaman.history') }}" class="save-profile-btn" style="max-width:260px; background: #007bff;">Lihat Riwayat Peminjaman</a>
