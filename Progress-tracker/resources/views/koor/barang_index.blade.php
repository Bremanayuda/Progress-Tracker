    ...
    <div class="retangle-putih">
        ...
        <div class="rect-barang">
            ...
            <div class="barang-row">
                ...
                <span class="col-jumlah">{{ $barang->jumlah }}</span>
                <span class="col-status">
                    @if($barang->peminjamans()->where('status', '!=', 'returned')->exists())
                        <span style="background:#ffc107; color:#000; padding:2px 8px; border-radius:4px; font-size:12px; font-weight:bold;">DIPINJAM</span>
                    @else
                ...
                <span class="col-detail">
                    <div class="btn-group">
                        <button class="btn-detail-barang" 
                            ...
                            data-peminjaman-aktif="{{ $barang->peminjamans()->where('status', '!=', 'returned')->count() }}">
                            Detail
                        </button>
...
<div class="modal-barang-bg" id="modalBarangBg">
    <div class="modal-barang">
        ...
        <div class="modal-info"><b>Jumlah:</b> <span id="modalBarangJumlah"></span></div>
